...
def main():
    # input_path
    img_path = r'D:\Github\BlackyYen\BlackyYen-public\machine_learning\Classification\ntut-ml-2020-classification\test\test'
    # output_path
    out_path = r'D:\Github\BlackyYen\BlackyYen-public\machine_learning\Classification\ntut-ml-2020-classification\test\test_resize'
    # mode == 1 補值
    # mode == 2 線性插植
    mode = 1
